package books.CrackingCodingInterview.datastructures.stackqueue.queueviastacks;
...
public class MyQueue<T> {
    ...
    */
     ...
     *      If old stack is Empty => pop all items from next stack and push in old stack.
