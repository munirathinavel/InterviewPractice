...
/**
 Problem 1.9
 Assume you have a method isSubstring which checks if one word is substring of other. Given 2 string s1 and s2, write a
 code to check if s2 is rotation of s1 using one call to isSubstring method.
